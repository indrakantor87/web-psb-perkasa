  ...
  return (
    <div className="space-y-2">
      ...
      <div
        ...
        style={{ ['--mp-sticky-left-2' as unknown as string]: '88px' }}
      >
        <table className="min-w-full border-collapse border border-gray-200 dark:border-gray-700">
          <thead className="hidden md:table-header-group bg-gray-50 dark:bg-gray-700">
            <tr>
              <th className="mp-sticky-1 hidden md:table-cell w-[88px] px-3 py-3 text-center text-[11px] font-bold uppercase tracking-wider text-gray-700 dark:text-gray-200">No</th>
            ...
            {currentTickets.map((ticket, index) => (
              <Fragment key={ticket.id}>
                <tr key={ticket.id} className={clsx("hover:bg-gray-50 dark:hover:bg-gray-700", !isMarketing && "transition-colors")}>
                  <td className="mp-sticky-1 hidden md:table-cell w-[88px] whitespace-nowrap px-3 py-3 text-xs text-gray-500 dark:text-gray-400">
