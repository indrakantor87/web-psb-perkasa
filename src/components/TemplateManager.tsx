...
export function TemplateManager() {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
      <h2 className="text-xl font-semibold mb-6 dark:text-white">Manajemen Template WhatsApp</h2>
      ...
      <form onSubmit={handleAdd} className="mb-8 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-700">
        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-200 mb-3">Tambah Template Baru</h3>
        <div className="space-y-4">
          <div>
            <label className="block text-xs text-gray-500 dark:text-gray-400 mb-1">Nama Template</label>
            <input
              type="text"
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border"
              placeholder="Halo {{name}}, konfirmasi pemasangan paket {{package}}..."
              rows={3}
            />
          </div>
        ...
        <table className="min-w-full divide-y divide-gray-300 dark:divide-gray-700">
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
            {loading ? (
              ...
              <tr>
                <td colSpan={4} className="text-center py-4 text-sm text-gray-500 dark:text-gray-400">Belum ada template</td>
              </tr>
            ) : (
